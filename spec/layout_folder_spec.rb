...
class TestLayout < Minitest::Test
  def setup
    @root_folder = LayoutFolder.create(:name => "Default")
    
    @folder_1 = LayoutFolder.create(:name => "Folder 1", :parent_id => @root_folder.id)
    @folder_2 = LayoutFolder.create(:name => "Folder 2", :parent_id => @root_folder.id)
    
    @folder_3 = LayoutFolder.create(:name => "Folder 3", :parent_id => @folder_1.id)
    @folder_4 = LayoutFolder.create(:name => "Folder 4", :parent_id => @folder_1.id)
    @folder_5 = LayoutFolder.create(:name => "Folder 5", :parent_id => @folder_1.id)
    @folder_6 = LayoutFolder.create(:name => "Folder 6", :parent_id => @folder_1.id)
    @folder_7 = LayoutFolder.create(:name => "Folder 6", :parent_id => @folder_1.id)
    @folder_8 = LayoutFolder.create(:name => "Folder 6", :parent_id => @folder_1.id)
    @folder_9 = LayoutFolder.create(:name => "Folder 6", :parent_id => @folder_1.id)
    
    @folder_10 = LayoutFolder.create(:name => "Folder 6", :parent_id => @folder_3.id)
    @folder_11 = LayoutFolder.create(:name => "Folder 11", :parent_id => @folder_3.id)
    @folder_12 = LayoutFolder.create(:name => "Folder 12", :parent_id => @folder_3.id)
    
    @layout = Layout.create(:layout_folder_id => @folder_4.id, :name => '', :content => '')
  ...
  def test_that_deleting_a_folder_causes_layout_deletion
    @folder_4.destroy 
  ...
  def test_that_deleting_a_folder_deletes_children_recursively
    ...
    folder = LayoutFolder[@folder_10.id]
